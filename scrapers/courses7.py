...
class SunbeamGenerativeAICourseScraper:
    ...
    def scrape_to_txt(self, output_path="text_data/sunbeam_courses.txt"):
        ...
        # ================= COURSE HEADER =================
        lines.append("\n" + "=" * 90 + "\n")
        lines.append("COURSE: MASTERING GENERATIVE AI\n")
        lines.append("=" * 90 + "\n\n")
        ...
        print("✅ Mastering Generative AI course saved to text_data/sunbeam_courses.txt")
