...
class SunbeamSparkCourseScraper:
    ...
    def scrape_to_txt(self, output_path="text_data/sunbeam_courses.txt"):
        ...
        url = (
            ...
            "apache-spark-mastery-data-engineering-pyspark"
        )
        self.driver.get(url)
        ...
        # ================= COURSE HEADER =================
        lines.append("\n" + "=" * 90 + "\n")
        lines.append("COURSE: APACHE SPARK MASTERY (DATA ENGINEERING WITH PYSPARK)\n")
        lines.append("=" * 90 + "\n\n")
        ...
        print("✅ Apache Spark course saved to text_data/sunbeam_courses.txt")
