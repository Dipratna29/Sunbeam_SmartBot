...
class SunbeamCoreJavaCourseScraper:
    ...
    def scrape_to_txt(self, output_path="text_data/sunbeam_courses.txt"):
        ...
        li = prereq_div.find_element(By.CSS_SELECTOR, ".list_style li")
        lines.append(f"- {li.text.strip()}\n\n")
        ...
        print("✅ Core Java course saved to text_data/sunbeam_courses.txt")
