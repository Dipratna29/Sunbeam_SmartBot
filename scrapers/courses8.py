...
class SunbeamAptitudeCourseScraper:
    ...
    def scrape_to_txt(self, output_path="text_data/sunbeam_courses.txt"):
        ...
        # ================= COURSE HEADER =================
        lines.append("\n" + "=" * 90 + "\n")
        lines.append("COURSE: APTITUDE TRAINING\n")
        lines.append("=" * 90 + "\n\n")
        ...
        # ================= COURSE CONTENT =================
        content_collapse_id = "collapse305"
        ...
        print("✅ Aptitude course saved to text_data/sunbeam_courses.txt")
