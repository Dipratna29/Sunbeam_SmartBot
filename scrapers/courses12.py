...
class SunbeamDreamLLMCourseScraper:
    ...
    def scrape_to_txt(self, output_path="text_data/sunbeam_courses.txt"):
        ...
        url = (
            ...
            "dreamllm-training-institute-pune"
        )
        self.driver.get(url)
        ...
        print("✅ Dream LLM course saved to text_data/sunbeam_courses.txt")
