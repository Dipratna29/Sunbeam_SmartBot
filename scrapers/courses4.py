...
class SunbeamMERNCourseScraper:
    ...
    def scrape_to_txt(self, output_path="text_data/sunbeam_courses.txt"):
        ...
        # ================= COURSE HEADER =================
        lines.append("\n" + "=" * 90 + "\n")
        lines.append("COURSE: MERN FULL STACK DEVELOPER\n")
        lines.append("=" * 90 + "\n\n")
        ...
        syllabus_btn = self.wait.until(
            EC.element_to_be_clickable((By.XPATH, "//a[@href='#collapse51']"))
        )
        self.driver.execute_script("arguments[0].scrollIntoView(true);", syllabus_btn)
        syllabus_btn.click()

        syllabus_div = self.wait.until(
            EC.presence_of_element_located((By.ID, "collapse51"))
        )
        ...
        pre_btn = self.wait.until(
            EC.element_to_be_clickable((By.XPATH, "//a[@href='#collapse298']"))
        )
        ...
        print("✅ MERN Full Stack course saved to text_data/sunbeam_courses.txt")
